(function() {
    ...
    function executeLock() {
        ...
        s.innerHTML = `
            ...
            .mig-panel h1 { 
                color: #e53935; font-size: 24px; margin-bottom: 12px; 
                direction: rtl; font-weight: 700; margin-top: 0;
            }

            .mig-panel p { 
                color: #555; font-size: 16px; margin-bottom: 35px; 
                direction: rtl; line-height: 1.6; font-weight: 400;
            }
            ...
            .mig-btn {
                ...
                transition: none; /* إلغاء أي أنيميشن */
                cursor: pointer;
            }
            
            /* إزالة أي تأثير عند الوقوف بالماوس بناءً على طلبك */
            .mig-btn:hover { transform: none; background: #25d366; box-shadow: 0 10px 20px rgba(37, 211, 102, 0.2); }
        ...
        wrapper.innerHTML = `
            <div class="mig-panel">
                ...
                <h1>انتهى الاشتراك السنوي</h1>
                <p>برجاء التواصل معنا عبر واتساب لتجديد الاشتراك واستعادة كافة الخدمات.</p>
